...
Route::group(['middleware' => 'admin'],function(){
    ...
    ->name('admin-doctors');
    Route::get('/edit/doctor/{speciality}',[AdminController::class,'editDoctorForm']);

    Route::get('/admin/create/doctor',[AdminController::class,'createDoctorForm']);

    Route::get('/admin/specialities',[AdminController::class,'specialityListing'])
